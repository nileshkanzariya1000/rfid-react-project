  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-10 text-center max-w-2xl mx-auto pt-4">
        ...
        >
          <Zap size={16} /> Subscription Plans
        </span>
        <h1 className="text-3xl md:text-4xl font-extrabold text-[#111827] mb-4 tracking-tight">Choose Your Access Token</h1>
        <p className="text-gray-500 text-lg">Select a plan to create a new subject and manage attendance tracking efficiently. Choose the duration that fits your needs.</p>
      </div>
      ...
      {tokens.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {tokens.map((token, index) => {
            // Determine if it should be highlighted/featured based on index or just general style
            const isFeatured = index === 1; // Highlight the middle/second one
            ...
            return (
              ...
              >
                ...
                <p className="text-gray-500 text-sm mb-6 h-10">{token.description || "Standard access plan for subject creation."}</p>
                ...
                <Link
                  to={`ProcideToAdd/${token.token_id}`}
